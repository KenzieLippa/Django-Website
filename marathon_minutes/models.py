...
class Result(models.Model):
    ...
    # gender/division
    # gives enough characters to enter it in, shouldnt be more than 6 chars
    ...
    # want to access hours minutes and seconds as individual elements
...
def load_data():
    ...
    filename = 'C:/Users/rosey/Desktop/2023_chicago_results.csv'
    f = open(filename)
